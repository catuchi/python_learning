...
label = Label(window, textvariable=equation_label, font=("consolas",20), bg="white", width=24, height=2, fg="black")
label.pack()
...
decimalButton = Button(frame, text=".", height=4, width=9, font=35, command= lambda: button_press("."))
decimalButton.grid(row=3,column=1)

clearButton = Button(window, text="clear", height=4, width=12, font=35, command=clear)
clearButton.pack()
